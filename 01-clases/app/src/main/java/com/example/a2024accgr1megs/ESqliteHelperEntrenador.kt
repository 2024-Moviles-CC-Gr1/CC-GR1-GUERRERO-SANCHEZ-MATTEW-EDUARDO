...
class ESqliteHelperEntrenador (
    ...
    //Es cuando exista alguna actualizacion a la BD
    ...
    // IMPORTANTE = SI se modifica la consulta se tiene que modificar el orden
    // de los parametros que se estan recibiendo
    fun consultarEntrenadorPorID(id:Int):BEntrenador?{
        val baseDatosLectura = readableDatabase
        val scriptConsultarLectura = """
